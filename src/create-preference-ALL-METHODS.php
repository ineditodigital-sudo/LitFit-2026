...
/**
 * ============================================
 * VERSIÓN CON TODOS LOS MÉTODOS HABILITADOS EXPLÍCITAMENTE
 * ============================================
 * 
 * Esta versión fuerza EXPLÍCITAMENTE todos los métodos de pago
 */
...
error_log("====== Nueva solicitud - TODOS LOS MÉTODOS ======");
...
// ============================================
// CREAR PREFERENCIA - VERSIÓN MINIMALISTA
// ============================================

// Esta versión usa SOLO los campos obligatorios
// para evitar cualquier conflicto con configuraciones
...
$preferenceData = [
    ...
    // Payer info (opcional pero ayuda)
    'payer' => [
        'email' => $formData['email'] ?? ''
    ]
];

error_log("📤 Enviando preferencia MINIMALISTA a Mercado Pago...");
error_log("🔓 Sin restricciones de métodos de pago");
error_log("📋 Preferencia: " . json_encode($preferenceData));
...
// LOG IMPORTANTE: Ver qué métodos de pago están disponibles
if (isset($mpResponse['payment_methods'])) {
    error_log("💳 Métodos disponibles: " . json_encode($mpResponse['payment_methods']));
}
