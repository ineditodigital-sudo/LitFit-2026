            ...
            {product.flavors && product.flavors.length > 0 && (
              <div className="mb-8">
                <div className="flex justify-between items-end mb-3">
                  <h3 className="font-black text-sm tracking-wide">SELECCIONA SABOR</h3>
                  <span className="text-xs font-bold text-[#00AAC7]">{selectedFlavor}</span>
                </div>
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  {product.flavors.map((flavor) => (
                    <button
                      ...
                      className={`relative p-3 rounded-xl border-2 transition-all flex flex-col items-center justify-center gap-2 group ${
                        selectedFlavor === flavor
                          ? 'border-[#00AAC7] bg-[#00AAC7]/5'
                          : 'border-gray-200 hover:border-gray-300 bg-white'
                      }`}
                    >
                      <span className={`text-[11px] font-black uppercase text-center transition-colors ${
                        selectedFlavor === flavor ? 'text-[#00AAC7]' : 'text-gray-600 group-hover:text-black'
                      }`}>
                        {flavor}
                      </span>
                    </button>
